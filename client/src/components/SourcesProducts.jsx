    ...
    <section className="py-10">
      ...
      <div className="grid grid-cols-4">
        <div className="m-4 flex flex-col items-center rounded-xl border-2 border-gray-200 bg-white py-10">
          <img src="/plant-fill.svg" alt="Plant icon" className="h-10" />
        ...
        <div className="m-4 flex flex-col items-center rounded-xl border-2 border-gray-200 bg-white py-10">
          <img src="/honey.svg" alt="Honey jar icon" className="h-10" />
        ...
        <div className="m-4 flex flex-col items-center rounded-xl border-2 border-gray-200 bg-white py-10">
          <img src="/chilli.svg" alt="Chilli icon" className="h-10" />
        ...
        <div className="m-4 flex flex-col items-center rounded-xl border-2 border-gray-200 bg-white py-10">
          <img src="/coffee.svg" alt="Coffee icon" className="h-10" />
